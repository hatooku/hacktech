...
# find specific corners of phone1
tL1 = (0, 0)
tR1 = (0, 0)
bL1 = (0, 0)
bR1 = (0, 0)
...
# find specific corners of phone2
tL2 = (0, 0)
tR2 = (0, 0)
bL2 = (0, 0)
bR2 = (0, 0)
if math.pow(phone2[0][0] - phone2[1][0], 2) + math.pow(phone2[0][1] - phone2[1][1], 2) > \
    math.pow(phone2[0][0] - phone2[2][0], 2) + math.pow(phone2[0][1] - phone2[2][1], 2):
    if phone2[0][0] != phone2[1][0]: # if distance to 1 > distance to 2
        if phone2[0][1] > phone2[1][1]: # assuming y positive downwards
            tL2 = phone2[1]
            tR2 = phone2[3]
            bL2 = phone2[0]
            bR2 = phone2[2]
...
# can return phone1, phone2, touchpoints1, touchpoints2, and tL, tR, bL, bR 1/2