...
def assignPoints(points):
    ...
    corners1 = touch.findCorners(phone1)
    if corners1:
        tL1, tR1, bL1, bR1 = corners1
    else: 
        return None
    
    
    corners2 = touch.findCorners(phone2)
    if corners2:
        tL2, tR2, bL2, bR2 = corners2
    else:
        return None
    
    return (touchpoints1, touchpoints2), (tL1, tR1, bL1, bR1), (tL2, tR2, bL2, bR2)